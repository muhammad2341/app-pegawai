...
<div class="bg-white p-6 rounded-lg shadow-lg">
  <div class="flex justify-between mb-4">
    ...
    <a href="{{ route('admin.attendances.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Tambah Absensi</a>
  </div>
  ...
  <table class="min-w-full bg-white border border-gray-200 rounded-lg">
    ...
    <tbody>
      ...
      <tr class="border-b hover:bg-gray-100">
        ...
        <td class="py-2 px-4">
          <a href="{{ route('admin.attendances.edit', $attendance->id) }}" class="text-blue-600 hover:underline">Edit</a> |
