...
<div class="min-h-screen bg-gray-50 p-8">
    ...
    <form action="{{ route('admin.salaries.edit', $salary->id) }}" method="GET" class="bg-white p-6 rounded shadow mb-6">
    ...
    <form action="{{ route('admin.salaries.update', $salary->id) }}" method="POST" class="bg-white p-8 rounded shadow-lg">
        @csrf
        @method('PUT')
