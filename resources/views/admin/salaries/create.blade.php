...
@section('page-title', 'Tambah Salary')

@section('content')
<div class="min-h-screen bg-gray-50 p-8">
    <h1 class="text-3xl font-bold mb-6 text-center">Tambah Salary</h1>

    <form action="{{ route('admin.salaries.create') }}" method="GET" class="bg-white p-6 rounded shadow mb-6">
    ...
    <form action="{{ route('admin.salaries.store') }}" method="POST" class="bg-white p-8 rounded shadow-lg">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="month" name="bulan" class="border p-2 w-full rounded" required>
        </div>

        <div class="mb-4">
            <label class="block font-semibold mb-2">Tunjangan</label>
            <input type="number" name="tunjangan" class="border p-2 w-full rounded" value="0">
        </div>

        <div class="mb-4">
            <label class="block font-semibold mb-2">Potongan</label>
            <input type="number" name="potongan" class="border p-2 w-full rounded" value="0">
        </div>
