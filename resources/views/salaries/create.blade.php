...
<div class="min-h-screen bg-gray-50 p-8">
    ...
    <form action="{{ route('salaries.create') }}" method="GET" class="bg-white p-6 rounded shadow mb-6">
    ...
    <form action="{{ route('salaries.store') }}" method="POST" class="bg-white p-8 rounded shadow-lg">
        @csrf
