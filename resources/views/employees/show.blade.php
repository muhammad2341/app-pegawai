...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="mt-4">
        <a href="{{ route('employees.edit', $employee->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-400">Edit</a>
        <a href="{{ route('employees.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-400">Kembali</a>
    </div>
</div>
@endsection
